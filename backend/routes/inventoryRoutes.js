...
router.get('/import/with-components/template', requireManageInventory, InventoryController.downloadAssetWithComponentsTemplate);
router.post('/import/with-components/preview', requireManageInventory, handleUpload, InventoryController.previewAssetWithComponentsImport);
router.post('/import/with-components/confirm', requireManageInventory, InventoryController.confirmAssetWithComponentsImport);
