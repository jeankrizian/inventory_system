...
async function seedNotifications() {
  const samples = [
    [1, 'New Borrow Request', 'A custodian submitted a borrow request (BRW-2024-004) for Science Textbook.', 'borrow_request', 4, '/pages/orders.html', 0],
    ...
    [1, 'Process Return Completed', 'Process return completed (RTN-2024-001): LCD Projector.', 'borrow_returned', 1, '/pages/orders.html', 1],
  ...
  console.log(`Sample notifications seeded. Admin unread: ${adminUnread[0].c}`);
  process.exit(0);
}
