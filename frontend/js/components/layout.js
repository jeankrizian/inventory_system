...
const NAV_ITEMS = [
  ...
  { href: '/pages/dashboard.html', icon: 'bi-grid-1x2-fill', label: 'Dashboard', page: 'dashboard', roles: ['admin', 'staff'] },

  { href: '/pages/inventory.html', icon: 'bi-box-seam', label: 'Inventory', page: 'inventory', roles: ['admin', 'staff'] },

  { href: '/pages/orders.html', icon: 'bi-box-arrow-in-right', label: 'Borrow', page: 'orders', roles: ['admin', 'staff'] },

  { href: '/pages/transfer-requests.html', icon: 'bi-arrow-left-right', label: 'Transfers', page: 'transfer-requests', roles: ['admin', 'staff'] },

  { href: '/pages/maintenance-requests.html', icon: 'bi-tools', label: 'Maintenance', page: 'maintenance-requests', roles: ['admin', 'staff'] },

  { href: '/pages/disposal-requests.html', icon: 'bi-trash3', label: 'Disposals', page: 'disposal-requests', roles: ['admin'] },

  {
    ...
    children: [
      ...
      { href: '/pages/manage-departments.html', icon: 'bi-building', label: 'Departments', page: 'manage-departments' },

      { href: '/pages/manage-locations.html', icon: 'bi-geo-alt', label: 'Locations', page: 'manage-locations' },

      { href: '/pages/manage-users.html', icon: 'bi-people', label: 'Users', page: 'manage-users' },

      { href: '/pages/suppliers.html', icon: 'bi-truck', label: 'Suppliers', page: 'suppliers' }

    ]

  },

  { href: '/pages/reports.html', icon: 'bi-bar-chart-line', label: 'Reports', page: 'reports', roles: ['admin'] },

  { href: '/pages/archive.html', icon: 'bi-archive', label: 'Archive', page: 'archive', roles: ['admin'] }
...
const FOOTER_NAV = [
  ...
  { href: '/pages/settings.html', icon: 'bi-gear', label: 'Settings', page: 'settings', roles: ['admin', 'staff'] },

  { action: 'logout', icon: 'bi-box-arrow-right', label: 'Log Out', roles: ['admin', 'staff'] }
...
const PAGE_PERMISSIONS = {
  ...
  'maintenance-requests': ['admin', 'staff'],

  'transfer-requests': ['admin', 'staff'],

  'disposal-requests': ['admin'],
...
function userHasPageAccess(page, user) {
  ...
  const allowed = PAGE_PERMISSIONS[page] || ['admin'];
